...
** News, feedback and discussion
   ...
   package are announced on the [[https://lists.r-forge.r-project.org/cgi-bin/mailman/listinfo/nmof-news][NMOF-news mailing list]]. The list is
   also available via [[http://dir.gmane.org/gmane.comp.finance.nmof.announce][Gmane]].
